...
.. only:: html
    ...
    .. nbinfo::
        ...
        :raw-html:`<a href="https://mybinder.org/v2/gh/scikit-optimize/scikit-optimize/{{ env.config.release }}?filepath={{ docname }}"><img alt="Binder badge" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>`
    __ https://github.com/scikit-optimize/scikit-optimize/blob/
