...
# -*- coding: utf-8 -*-
#
# scikit-optimize documentation build configuration file, created by
# sphinx-quickstart on Tue Jul 11 16:28:14 2017.
#
...
man_pages = [
    (master_doc, 'scikit-optimize', 'scikit-optimize Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'scikit-optimize', 'scikit-optimize Documentation',
     author, 'scikit-optimize', 'One line description of project.',
     'Miscellaneous'),
]
