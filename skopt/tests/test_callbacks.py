...
from skopt.benchmarks import Sumquares
from skopt.benchmarks import Forrester
...
def test_deadline_stopper():
    ...
    bench3 = Forrester()
    gp_minimize(bench3, bench3.dimensions, callback=deadline, n_calls=10, random_state=1)
