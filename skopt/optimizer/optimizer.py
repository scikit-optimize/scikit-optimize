...
class Optimizer(object):
    ...
    def update_next(self):
        """Updates the value returned
        by opt.ask(). Useful if a parameter
        was updated after ask was called."""
        self.cache_ = {}
        # Ask for a new next_x. Usefull if new constraints have
        # been added or lenght_scale has been tweaked.
    ...
    def get_result(self):
        """Returns the same result that would be returned by
        opt.tell() but without calling tell"""
        return create_result(self.Xi, self.yi, self.space, self.rng,
                             models=self.models)
